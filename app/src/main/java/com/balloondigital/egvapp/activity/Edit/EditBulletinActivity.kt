...
import kotlinx.android.synthetic.main.activity_edit_bulletin.*
...
class EditBulletinActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Editar Informativo"
    ...
    private fun bindData() {
        ...
        etBulletinTitle.setText(mBulletin.title)
        etBulletinResume.setText(mBulletin.resume)
        if(!mBulletin.text.isNullOrEmpty()) {
            mKnifeText = mBulletin.text!!
            txtOpenKinfe.text = KnifeParser.fromHtml(mBulletin.text)
        }
    }
