...
import kotlinx.android.synthetic.main.activity_affiliates_embassies_awaiting.*

class AffiliatesEmbassiesAwaitingActivity : AppCompatActivity(), SearchView.OnQueryTextListener, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_affiliates_embassies_awaiting)
        supportActionBar!!.title = "Embaixadas para aprovação"
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)

        val bundle: Bundle? = intent.extras
        if (bundle != null) {
            mUser = bundle.getSerializable("user") as User
            mSponsorID = bundle.getString("sponsor_id", "")
        }
